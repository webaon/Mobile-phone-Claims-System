        ...
        <div class="col-md-10">
            <div class="panel panel-warning">
                <div class="panel-heading">รายละเอียดการเคลม 
                    <a href="admin_job.php" class="btn btn-sm btn-warning" title="ย้อนกลับ"><span class="glyphicon glyphicon-arrow-left"></span> กลับ</a>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-10">
                        <table class="table table-condensed">
                            ...
                            <tr>      
                                <td>วันที่ส่งเคลม :</td>
                                <td style="color: darkgray"><?php echo date_format($date01,'d/m/y');?></td>
                                <td>วันที่รับเรื่อง :</td>
                                <td style="color: darkgray"><?php echo date_format($date2,'d/m/y');?></td>
                               
                            </tr>
                            <tr>    
                                <td>วันที่ปิดงาน :</td>
                                <td style="color: darkgray"><?php echo date_format($date3,'d/m/y');?></td>
                                <td>วันที่สาขารับคืน :</td>
                                <td style="color: darkgray"><?php echo date_format($date4,'d/m/y');?></td>
                                
                            </tr>
                            <tr>   
                                <td>วันที่ลูกค้ารับคืน :</td>
                                <td style="color: darkgray"><?php echo date_format($date5,'d/m/y');?></td>
                        ...
                        <a class="btn btn-default btn-sm btn-lg btn-block" type="buttonn" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                            <center> ดูรายการซ่อม </center>
                          </a>
