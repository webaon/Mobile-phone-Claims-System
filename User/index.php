...
$sql="SELECT * FROM job_service WHERE status='$s1' and user_id='$us' ";
$result = $conn->query($sql) ;
$num_rows = mysqli_num_rows($result);

$sql1="SELECT * FROM job_service WHERE status='$s2' and user_id='$us' ";
$result1 = $conn->query($sql1) ;
$num_rows1 = mysqli_num_rows($result1);

$sql2="SELECT * FROM job_service WHERE status='$s3' and user_id='$us' ";
$result2 = $conn->query($sql2) ;
$num_rows2 = mysqli_num_rows($result2);

$sql3="SELECT * FROM job_service WHERE status='$s4' and user_id='$us' ";
